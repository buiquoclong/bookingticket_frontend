...
import "../AdminBookTicketReturn/AdminBookTicketReturn.scss";
    ...
    switch (trangthai) {
      ...
      default:
        return isSelected
          ...
          : { src: seat_active, tdStyle: {}, spanStyle: {} }; // Default case
    }
  };
    ...
    return (
      <div className="seatBook">
        <div className="numTicket">
          <span className="numOfTicket">
            {selectedSeats.length} Vé
            <br />
            <span>{formatSelectedSeatsById(tuyenId)}</span>
          </span>
        </div>
        <div className="priceTicket">
          <span className="price">
            ...
            <span className="totalPrice">
              {calculateTotalPriceById(tuyenId).toLocaleString("vi-VN")}đ
            </span>
          </span>
          <button
            type="button"
            className="btn chooseButton"
            onClick={() => handleContinueClick(tuyenId)}
          >
            <span>Tiếp tục</span>
          </button>
        </div>
          ...
          <div className="listResultSearch flex">
            <div className="listHeader">
              ...
              {kind === "Khứ hồi" && (
                <div>
                  <h1>
                    Chuyến: {diemDiName} - {diemDenName} (Lượt về)
                  </h1>
                  <h1>Ngày: {formatDate(dayReturn)}</h1>
                </div>
              )}
                        ...
                        <div className="routeInfo">
                          <div className="nameInfo">
                            ...
                            <span className="timeend">
                              {renderTimeWithTwoHours(trip)}
                            </span>
                          </div>
                          <div className="dessInfo">
                            <div className="desStart">
                              <span className="nameStart">
                                {trip.route.diemDi.name}
                              </span>
                            </div>
                            <div className="desEnd">
                              <span className="nameEnd">
                                {trip.route.diemDen.name}
                              </span>
                            </div>
                          </div>
                        </div>
