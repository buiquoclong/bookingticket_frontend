...
const AdminCity = () => {
  ...
  const handleUpdateCity = async (e) => {
    ...
    try {
      ...
      formData.append(
        "city",
        new Blob([JSON.stringify({ name: currentCity.name })], {
      ...
      const response = await fetch(
        `http://localhost:8081/api/city/${currentCity.id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`, // Thêm token vào header
  ...
  return (
    <div className="main-container">
      ...
      <Breadcrumbs aria-label="breadcrumb">
        ...
        <Link underline="hover" color="inherit" href="/admin/cities">
          Thành phố
        </Link>
      </Breadcrumbs>
              ...
              <div className="modal-body">
                <form>
                  ...
                  <div className="listButton">
                    ...
                    <button className="save" onClick={handleCreateCity}>
                      Tạo
                    </button>
                  </div>
                </form>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="listButton">
                  ...
                  <button type="button" className="save" onClick={removeCity}>
                    Xóa
                  </button>
                </div>
              </div>
