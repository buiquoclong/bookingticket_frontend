      ...
      cell: (row) => (
        <div
          style={{
            ...
            alignItems: "center",
            width: "100%",
            backgroundColor: levelColorMap[row.level] || "transparent",
            padding: ".3rem 0rem",
            borderRadius: "5px",
            fontWeight: "600",
            color: "",
        ...
        >
          {LevelMap[row.level] || "Unknown Status"}
        </div>
      ),
    },
  ];
  ...
  return (
    <div className="main-container">
      ...
      <Breadcrumbs aria-label="breadcrumb">
        ...
        <Link underline="hover" color="inherit" href="/admin/logs">
          Logs
        </Link>
      </Breadcrumbs>
              ...
              <div class="modal-body">
                <form>
                  <div className="infoCity">
                    ...
                    <input
                      type="text"
                      value={currentCity.mave}
                      onChange={(e) =>
                        setCurrentCity({ ...currentCity, mave: e.target.value })
                      }
                    />
                  </div>
                  <div className="infoCity">
