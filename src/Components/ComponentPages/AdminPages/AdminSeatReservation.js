...
const AdminSeatReservation = () => {
    ...
    async (searchDebounce) => {
      try {
        const response = await fetch(
          `http://localhost:8081/api/seat_reservation/page?page=${page}&size=10&name=${searchDebounce}`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      const data = await fetchSeatReservations(searchDebounce);
    ...
    fetchData();
  }, [page, searchDebounce, fetchSeatReservations]);
  ...
  return (
    <div className="main-container">
      ...
      <Breadcrumbs aria-label="breadcrumb">
        ...
        <Link underline="hover" color="inherit" href="/admin/seat-reservation">
          Ghế đặt trước
        </Link>
      </Breadcrumbs>
              ...
              <div class="modal-body">
                <form>
                  ...
                  <div className="infoCity">
                    ...
                    <input
                      type="text"
                      value={currentCity.nameVehical}
                      onChange={(e) =>
                        setCurrentCity({
                          ...currentCity,
                          nameVehical: e.target.value,
                        })
                      }
                    />
                  </div>
                  <div className="infoCity">
                    ...
                    <input
                      type="text"
                      value={currentCity.seatBook}
                      onChange={(e) =>
                        setCurrentCity({
                          ...currentCity,
                          seatBook: e.target.value,
                        })
                      }
                    />
                  </div>
                  <div className="infoCity">
                    ...
                    <input
                      type="text"
                      value={currentCity.vehicleNumber}
                      onChange={(e) =>
                        setCurrentCity({
                          ...currentCity,
                  ...
                  <div className="infoCity">
                    ...
                    <input
                      type="text"
                      value={currentCity.seatNone}
                      onChange={(e) =>
                        setCurrentCity({
                          ...currentCity,
                          seatNone: e.target.value,
                        })
                      }
                    />
                  </div>
