...
const MyRating = () => {
  ...
  const NoDataComponent = () => (
    <div className="emptyData">Bạn chưa có đánh giá nào</div>
  );
  return (
        ...
        <div className="searchIn">
          ...
          >
            ...
            <Select
              ...
              label="Đánh giá"
            >
              <MenuItem value="1" style={{ justifyContent: "center" }}>
                <span style={{ color: "gold", fontSize: "20px" }}>★</span>
                <span style={{ color: "grey", fontSize: "20px" }}>★★★★</span>
              </MenuItem>
              <MenuItem value="2" style={{ justifyContent: "center" }}>
                <span style={{ color: "gold", fontSize: "20px" }}>★★</span>
                <span style={{ color: "grey", fontSize: "20px" }}>★★★</span>
              </MenuItem>
              <MenuItem value="3" style={{ justifyContent: "center" }}>
                <span style={{ color: "gold", fontSize: "20px" }}>★★★</span>
                <span style={{ color: "grey", fontSize: "20px" }}>★★</span>
              </MenuItem>
              <MenuItem value="4" style={{ justifyContent: "center" }}>
                <span style={{ color: "gold", fontSize: "20px" }}>★★★★</span>
                <span style={{ color: "grey", fontSize: "20px" }}>★</span>
              </MenuItem>
              <MenuItem value="5" style={{ justifyContent: "center" }}>
                <span style={{ color: "gold", fontSize: "20px" }}>★★★★★</span>
              </MenuItem>
            </Select>
          </FormControl>
              ...
              <div class="modal-body">
                <div className="infoBookingTicket">
                  ...
                  <div className="lineInfo">
                    ...
                    <div className="rightInfo">
                      <span>
                        {selectedReview.trip.vehicle.kindVehicle.name}
                      </span>
                    </div>
                  </div>
                  <div className="lineInfo">
